                        ...
                        <div class="card-body relative overflow-hidden bg-zinc-900 rounded-md mb-5">
                            <div class="relative z-10 grid grid-cols-12 items-center">
                                <div class="lg:col-span-8 col-span-12">
                                    ...
                                    <p class="mb-5 text-white/70 text-sm">An ecommerce dashboard has just that purpose. It provides your ecommerce team with a clear overview of key financial and website KPIs at any time.</p>
                                    <button type="button" class="btn bg-primary text-white">Take a Product</button>
                                </div>

                                <div class="col-span-4 ms-auto lg:block hidden">
                                    <img src="/assets/dashboard-BxFgfF4y.png" alt="" class="h-40">
                                </div>
                            </div>

                            <div class="absolute inset-0">
                                <svg xmlns="http://www.w3.org/2000/svg" class="size-full" version="1.1" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:svgjs="http://svgjs.dev/svgjs" preserveAspectRatio="none" viewBox="0 0 1440 560">
                    ...
                    <div class="lg:col-span-2 col-span-1">
                        <div class="card">
                            <div class="card-header">
                                ...
                                <div class="relative">
                                    <input type="text" data-provider="flatpickr" data-date-format="d M, Y" data-range-date="true" placeholder="Select Date" class="form-input form-input-sm ps-9" />
                                    ...
                                    <div class="col-span-1">
                                        <div class="flex items-center gap-3">
                                            ...
                                            <div>
                                                ...
                                                <h5 class="text-base font-semibold text-default-800">$<span class="counter-value" data-target="1517.36">1,517.36</span>k</h5>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-span-1">
                                        <div class="flex items-center gap-3">
                                            ...
                                            <div>
                                                ...
                                                <h5 class="text-base font-semibold text-default-800">$<span class="counter-value" data-target="746.84">746.84</span>k</h5>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="md:col-span-5 col-span-1">
                                        <div class="flex flex-col gap-3">
                                            <div class="flex items-center gap-2">
                                                <div class="bg-success size-3" style="clip-path: polygon(50% 0%, 0% 100%, 100% 100%);"></div>
                                                <p class="text-success">Search Engine (22%)</p>
                                            </div>

                                            <div class="flex items-center gap-2">
                                                <div class="bg-secondary size-3" style="clip-path: polygon(50% 0%, 0% 100%, 100% 100%);"></div>
                                                <p class="text-secondary">Referral (34%)</p>
                                            </div>

                                            <div class="flex items-center gap-2">
                                                <div class="bg-info size-3" style="clip-path: polygon(50% 0%, 0% 100%, 100% 100%);"></div>
                    ...
                    <div class="card">
                                        ...
                                        <table class="min-w-full divide-y divide-default-200 dark:divide-white/14">
                                            <thead class="bg-default-150">
                                                <tr class="text-sm font-normal text-default-500 whitespace-nowrap">
                                                    ...
                                                    <th scope="col" class="px-3.5 py-3 text-start">Total Amount</th>
                                            ...
                                            <tbody class="divide-y divide-default-200 dark:divide-white/14">
                                                <tr class="text-default-800 font-normal">
                                                    ...
                                                    <td class="px-3.5 py-2.5 whitespace-nowrap">
                                                        <span class="inline-flex items-center gap-x-1.5 py-0.5 px-2.5 rounded text-xs font-medium bg-success/10 text-success border border-success/30">Delivered</span>
                                                    </td>
                                                    <td class="px-3.5 py-2.5">
                                                        <div class="hs-dropdown relative inline-flex">
                                                            <button type="button" class="hs-dropdown-toggle btn size-7.5 bg-default-150 hover:bg-default-600 text-default-500 hover:text-white" aria-haspopup="menu" aria-expanded="false" aria-label="Dropdown" hs-dropdown-placement="bottom-end">
                                                ...
                                                <tr class="text-default-800 font-normal">
                                                    ...
                                                    <td class="px-3.5 py-2.5 whitespace-nowrap">
                                                        <span class="inline-flex items-center gap-x-1.5 py-0.5 px-2.5 rounded text-xs font-medium bg-info/10 text-info border border-info/30">Shipping</span>
                                                    </td>
                                                    <td class="px-3.5 py-2.5">
                                                        <div class="hs-dropdown relative inline-flex">
                                                            <button type="button" class="hs-dropdown-toggle btn size-7.5 bg-default-150 hover:bg-default-600 text-default-500 hover:text-white" aria-haspopup="menu" aria-expanded="false" aria-label="Dropdown" hs-dropdown-placement="bottom-end">
                                                ...
                                                <tr class="text-default-800 font-normal">
                                                    ...
                                                    <td class="px-3.5 py-2.5 whitespace-nowrap">
                                                        <span class="inline-flex items-center gap-x-1.5 py-0.5 px-2.5 rounded text-xs font-medium  bg-secondary/10 text-secondary border border-secondary/30">New</span>
                                                    </td>
                                                    <td class="px-3.5 py-2.5">
                                                        <div class="hs-dropdown relative inline-flex">
                                                            <button type="button" class="hs-dropdown-toggle btn size-7.5 bg-default-150 hover:bg-default-600 text-default-500 hover:text-white" aria-haspopup="menu" aria-expanded="false" aria-label="Dropdown" hs-dropdown-placement="bottom-end">
                                                ...
                                                <tr class="text-default-800 font-normal">
                                                    ...
                                                    <td class="px-3.5 py-2.5 whitespace-nowrap text-sm">$349.00</td>
                                                    <td class="px-3.5 py-2.5 whitespace-nowrap">
                                                        <span class="inline-flex items-center gap-x-1.5 py-0.5 px-2.5 rounded text-xs font-medium bg-warning/10 text-warning border border-warning/30">Pending</span>
                                                    </td>
                                                    <td class="px-3.5 py-2.5">
                                                        <div class="hs-dropdown relative inline-flex">
                                                            <button type="button" class="hs-dropdown-toggle btn size-7.5 bg-default-150 hover:bg-default-600 text-default-500 hover:text-white" aria-haspopup="menu" aria-expanded="false" aria-label="Dropdown" hs-dropdown-placement="bottom-end">
                        ...
                        <div class="card-footer">
                            ...
                            <nav class="flex items-center gap-2" aria-label="Pagination">
                                <button type="button" class="btn btn-sm border bg-transparent border-default-200 text-default-600 hover:bg-primary/10 hover:text-primary focus:bg-primary/10 focus:text-primary hover:border-primary/10">
                                    <i data-lucide="chevron-left" class="size-4 me-1"></i> Prev
                                </button>

                                <button type="button" class="btn size-7.5 bg-transparent border border-default-200 text-default-600 hover:bg-primary/10 hover:text-primary focus:bg-primary/10 focus:text-primary hover:border-primary/10">
                                    1
                                </button>
                                ...
                                <button type="button" class="btn btn-sm border bg-transparent border-default-200 text-default-600 hover:bg-primary/10 hover:text-primary focus:bg-primary/10 focus:text-primary hover:border-primary/10">Next
                ...
                <div class="grid lg:grid-cols-4 grid-cols-1 gap-5">
                    <div class="card">
                        <div class="card-header">
                            ...
                            <div class="hs-dropdown relative inline-flex">
                                <button type="button" class="hs-dropdown-toggle btn size-7.5 text-sm font-semibold rounded-lg hover:bg-default-150" aria-haspopup="menu" aria-expanded="false" aria-label="Dropdown" hs-dropdown-placement="bottom-end">
                            ...
                            <div>
                                ...
                                <div class="divide-y divide-default-200 dark:divide-white/14">
                                    <div class="flex items-center justify-between text-sm">
                                        <div class="flex items-center gap-3 py-2.25">
                                            <div class="size-8 rounded-full bg-default-100">
                                                <img src="/assets/avatar-2-B613dbkY.png" alt="" class="size-8 rounded-full">
                                            </div>
                                            <div>
                                    ...
                                    <div class="flex items-center justify-between text-sm">
                                        <div class="flex items-center gap-3 py-2.25">
                                            <div class="size-8 rounded-full bg-default-100">
                                                <img src="/assets/avatar-3-CuoB696V.png" alt="" class="size-8 rounded-full">
                                            </div>
                                            <div>
                                    ...
                                    <div class="flex items-center justify-between text-sm">
                                        <div class="flex items-center gap-3 py-2.25">
                                            <div class="size-8 rounded-full bg-default-100">
                                                <img src="/assets/avatar-4-CCRr3MbC.png" alt="" class="size-8 rounded-full">
                                            </div>
                                            <div>
                                    ...
                                    <div class="flex items-center justify-between text-sm">
                                        <div class="flex items-center gap-3 pt-2">
                                            <div class="size-8 rounded-full bg-default-100">
                                                <img src="/assets/avatar-5-ACaGxkSo.png" alt="" class="size-8 rounded-full">
                                            </div>
                                            <div>
                        ...
                        <div class="card-body">
                            <div class="flex items-center gap-3">
                                ...
                                <div class="text-sm">
                                    ...
                                    <h5 class="font-semibold text-default-800">$<span class="counter-value" data-target="746.84">746.84</span>k</h5>
                                </div>
                            </div>
                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <div class="hs-dropdown relative inline-flex">
                                <button type="button" class="hs-dropdown-toggle bt size-7.5 text-sm font-semibold rounded-lg hover:bg-default-150" aria-haspopup="menu" aria-expanded="false" aria-label="Dropdown" hs-dropdown-placement="bottom-end">
                                    <i class="iconify lucide--ellipsis-vertical size-4 text-default-500"></i>
                                </button>
                        ...
                        <div class="card-body">
                            <div class="flex flex-col gap-5">
                                <div class="flex items-center justify-between">
                                    <div class="flex items-center gap-3 whitespace-nowrap">
                                        <div class="flex items-center justify-center rounded-md size-10 bg-default-100">
                                            <img src="/assets/img-02-C91JHf1M.png" alt="" class="h-6">
                                        </div>

                                        <div>
                                            <h6 class="font-semibold text-default-800 md:w-full truncate w-43 mb-1 text-sm">Mesh Ergonomic Black Chair</h6>
                                ...
                                <div class="flex items-center justify-between">
                                    <div class="flex items-center gap-3">
                                        <div class="flex items-center justify-center rounded-md size-10 bg-default-100">
                                            <img src="/assets/img-03-C8EnjP1K.png" alt="" class="h-6">
                                        </div>
                                        <div>
                                            <h6 class="font-semibold text-default-800 md:w-full truncate w-43 text-sm mb-1">Fastcolors Typography Men </h6>
                                            <div class="flex items-center text-warning gap-0.5">
                                                <i data-lucide="star" class="fill-warning size-3.5"></i>
                                                <i data-lucide="star" class="fill-warning size-3.5"></i>
                                                <i data-lucide="star" class="fill-warning size-3.5"></i>
                                ...
                                <div class="flex items-center justify-between">
                                    <div class="flex items-center gap-3">
                                        <div class="flex items-center justify-center rounded-md size-10 bg-default-100">
                                            <img src="/assets/img-04-BzlzTEbH.png" alt="" class="h-6">
                                        </div>
                                        <div>
                                            <h6 class="font-semibold text-default-800 md:w-full truncate w-43 text-sm mb-1">Mesh Ergonomic Green Chair </h6>
                                            <div class="flex items-center text-warning gap-0.5">
                                                <i data-lucide="star" class="fill-warning size-3.5"></i>
                                                <i data-lucide="star" class="fill-warning size-3.5"></i>
                                                <i data-lucide="star" class="fill-warning size-3.5"></i>
                                ...
                                <div class="flex items-center justify-between">
                                    <div class="flex items-center gap-3">
                                        <div class="flex items-center justify-center rounded-md size-10 bg-default-100">
                                            <img src="/assets/img-05-RFpkKl-c.png" alt="" class="h-6">
                                        </div>
                                        <div>
                                            <h6 class="font-semibold text-default-800 md:w-full truncate w-43 text-sm mb-1">Techel Black Bluetooth Soundbar </h6>
                                            <div class="flex items-center text-warning gap-0.5">
                                                <i data-lucide="star" class="fill-warning size-3.5"></i>
                                                <i data-lucide="star" class="fill-warning size-3.5"></i>
                                                <i data-lucide="star" class="fill-warning size-3.5"></i>
                                ...
                                <div class="flex items-center justify-between">
                                    <div class="flex items-center gap-3">
                                        <div class="flex items-center justify-center rounded-md size-10 bg-default-100">
                                            <img src="/assets/img-06-joo6Gm4I.png" alt="" class="h-6">
                                        </div>
                                        <div>
                                            <h6 class="font-semibold text-default-800 md:w-full truncate w-43 text-sm mb-1">Bovet Fleurier AIFSQ029</h6>
                                            <div class="flex items-center text-warning gap-0.5">
                                                <i data-lucide="star" class="fill-warning size-3.5"></i>
                                                <i data-lucide="star" class="fill-warning size-3.5"></i>
                                                <i data-lucide="star" class="fill-warning size-3.5"></i>
